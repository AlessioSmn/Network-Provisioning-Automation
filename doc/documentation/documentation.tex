...
\paragraph{Expansion}
The current approach used to achieve a form of load balancing across the two upstream links can be replicated to balance traffic on the customer side of the network. We chose not to implement this as only the upstream links were required and it would be conceptually very similar, just increasing the complexity of the algorithm.
